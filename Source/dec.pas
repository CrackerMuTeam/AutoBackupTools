...
interface
var
masterid,masterpwd,masterdsn,mastercatalog:string;
...
mudsn,muid,mupwd,catalog,memudsn,memuid,memupwd,mecatalog,vs,ancientnum5,ancientnum10 ,
guildsave:string;
//configs de tabela
...
//configs de tabela
memb_info,memb___id,vip,creditos,moedas,options,  //memb_info
...
Config,editcmtedit,ancientnormal,ancient5,ancient10,ancient52,ancient102:string; //main
...
error15part3,error16,error17,question6,question7,Confirm3,confirm7,
Confirm5,Confirm6,Error18,Error19,Error20,Error21,error25,error26,error27,error28 ,error29,error30,error31,
Error22,error23,error24,question8,question9,question10,question11,question12,question13:string; //mainmsg
...
configtype,programname,deletetext,information:string;
